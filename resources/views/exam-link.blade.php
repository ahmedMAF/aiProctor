    ...
    <section>
        <div class="continer" style="position: relative">
            <div class="page">
                ...
                <div>
                    <p id="result" style="display: none; font-size: 20px; font-weight: bold; color:#151515;">Please wait...</p>
                    <a id="retry" style="display: none" href="/student/examlink/{{ $id }}"
                        class="next">Retry</a>
                </div>
            </div>
            <div class="instraction">
                <div class="content">
                    ...
                    <ol>
                        ...
                        <li>After verification, a red dot will appear on the screen. Please look directly at it and keep it
                            between your eyes for 5 seconds to complete the calibration process.</li>
                        <li>Once calibration is complete, the exam will start automatically.</li>
                        <li>During the exam, you will be monitored by AI which tracks your face, gaze, and head movements,
                            analyzes your facial expressions, emotions, and behavior, detects if there is more than one
                            face, and listens to surrounding audio.</li>
                        <li>The session will be documented by recording audio and periodically capturing images. Screen
                            video may be recorded if any suspicious behavior is detected.</li>
                        <li>The teacher will receive a detailed report including emotional behavior analysis and any
                            suspected cheating indicators, supported by evidence such as images, video, and audio.</li>
                        <li>No one else is allowed to be present in the room during the exam.</li>
                        <li>The use of additional devices such as mobile phones, earphones, or secondary screens is strictly
                            prohibited.</li>
                    </ol>
                    <div class="agree">
