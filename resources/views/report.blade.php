            ...
            <div class="emotion">
                @php
                    ...
                    if ($dangerScore >= 70) {
                        $level = 'High';
                        $message =
                            'Significant emotional signals were detected (e.g., fear, nervousness, anger). Immediate review of the session is recommended.';
                    } elseif ($dangerScore >= 40) {
                        $level = 'Moderate';
                        $message =
                            'Moderate emotional activity detected. Please review the session to confirm if any unusual behavior occurred.';
                    } else {
                        $level = 'Low';
                        $message =
                            'No concerning emotional patterns detected. The session appears within normal emotional range.';
                    }
